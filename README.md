# [Curso de introducción a la estadística descriptiva con R Studio y Python]chchc(https://www.udemy.com/estadistica-descriptiva/?couponCode=FROM_BOKDOWN_RSTUDIO)
